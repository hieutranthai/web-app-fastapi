...
from settings import SQLALCHEMY_DATABASE_OBJECT, SQLALCHEMY_DATABASE_OBJECT_ASYNC
...
#engine = create_engine(SQLALCHEMY_DATABASE_OBJECT)
#async_engine = create_async_engine(SQLALCHEMY_DATABASE_OBJECT_ASYNC)
